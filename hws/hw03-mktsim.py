...
Week-5:Homework-3::Submitted 2013.09.30
By: Frank Xia
...
#                print "Updating Balance: idx=",ldt_timestamps[i],"SYM=",s_sym,"Price=",traded_price,"@Shrs=",traded_shares,": Movement=",d_movement_intraday
        if i == 0:
...
#    print(ls_symbols)
    ...
    # PORT_1: 2011.01.10 - 2011.12.20
    dt_start = dt.datetime(2011, 1, 10)
    dt_last = dt.datetime(2011, 12, 20)
  
    # PORT_2: 2011.01.14 - 2011.12.14
    dt_start = dt.datetime(2011, 1, 14)
    dt_last = dt.datetime(2011, 12, 14)
...
#    df_trade_matrix = create_trade_matrix(d_data, ls_symbols, ls_dates, sys.argv[2])
